...
import { getAll, getByAlte, create, remove, update, getById } from "../personaje/personaje.controller";
import { check } from "express-validator";
import { validate, validatePassword } from "../personaje/validator/validate"
